...
class CylinderTest {
    ...
    void testGetNormal() {
        ...
        Vector m = cyl.getNormal(new Point(0, 0, 1.5));
        assertEquals(new Vector(0, 1, 0), m, "Bad normal to lower base of cylinder");
        ...
        Vector n = cyl.getNormal(new Point(0, 0, 1));
        assertEquals(new Vector(0, 1, 0), n, "Bad normal to center of lower base");
