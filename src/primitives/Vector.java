...
public class Vector extends Point
{
     ...
     * Throws an IllegalArgumentException if vector zero is passed
     * @param c Double3 type object that represent 3 coordinates
     */
     ...
     * @param s of type double that we use to multiply the vector with
     ...
     * @param v the vector that we preform dot product with the current vector
     ...
     * @param v the vector that we preform cross product with the current vector
