...
public class Polygon extends Geometry {
   ...
   public Polygon(Point... vertices) {
      ...
      // Generate the direction of the polygon according to the angle between last and first edge being less than 180 deg. It is held by the sign of its dot product with the normal. If all the rest consequent edges will generate the same sign - the polygon is convex ("kamur" in Hebrew).
      ...
      for (var i = 1; i < vertices.length; ++i) {
         ...
         // Test the consequent edges have the same sign of cross product
         edge1 = edge2;
